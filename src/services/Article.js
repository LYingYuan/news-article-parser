...
class Article {
  ...
  async summarizeArticle() {
    try {
      ...
      const prompt =
        "请你总结这篇文章，要求：1.字数严格控制在 100-120 字；2.重点利用文章中的数据，使其更有说服力；3.不要使用吸引眼球的夸张语法，理性叙事总结；4.如果有，请注明这篇文章的来源、研究团队等，并将其放置于摘要的开头；5.不要出现“这篇文章”等字眼；6.不用加“摘要：”、“文章摘要：等词语，直接返回摘要，无需提示其为摘要”；7.不要出现文章未提及的内容及数据。\n---\n";
